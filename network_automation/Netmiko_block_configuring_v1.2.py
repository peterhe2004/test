...
def send_configuration_to_device(device_info):
    ...
    try:
        ...
        # Capture the running configuration before changes
        ...
        # backup config again after changes
        results.append(copy_running_to_tftp(connection))

        time.sleep(10)

        # Capture the running configuration after changes
        running_config_after = get_running_config(connection)

        # Compare configurations and output the differences
        diff = unified_diff(
